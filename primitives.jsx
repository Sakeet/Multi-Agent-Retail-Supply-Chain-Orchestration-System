...
function Icon({ name, size = 14 }) {
  const s = size;
  const p = { width: s, height: s, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.75, strokeLinecap: 'round', strokeLinejoin: 'round' };
  switch (name) {
    ...
    case 'broom': return <svg {...p}><path d="M19 11V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v4"/><path d="M5 11h14l-2 10H7L5 11z"/></svg>;
    default: return null;
  }
}
window.Icon = Icon;
